...
mp: main.o parser.o cst.o frame.o types.o evaluator.o builtins.o units.o
	$(CXX) -o $@ $^

main.o: main.cc parser.h units.h
parser.o: parser.cc parser.h cst.h frame.h types.h evaluator.h units.h
cst.o: cst.cc cst.h
