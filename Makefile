...
test: test-packed-record test-ifopt test-directive-push-pop test-h-directive-strings test-directive-diagnostics test-case-statement test-math-intrinsics test-loop-control test-empty-statement test-block-comments test-generic-intrinsics test-length-native-types test-pos-builtin test-copy-builtin test-chr-builtin test-str-builtin test-val-builtin test-octstr-builtin test-strlen-builtin test-getmem-builtin test-move-builtin test-initialize-finalize test-filldword-builtin test-prefetch-builtin test-comparechar-builtin test-sizeof-layout test-set-literals test-include-exclude-builtin test-writable-cast test-write-builtin test-builtin-overload-isolation test-i-directive-scoping test-io-checking test-runerror-halt test-unit-lifecycle test-unit-uses-scope test-symbol-resolution test-delete-builtin test-insert-builtin test-properties test-with-designator test-function-pointers test-single-type test-shortstring-type test-typed-const-aggregates test-explicit-enum-values test-type-block-publication test-inherited-calls test-file-types test-classtype-emission test-metaclass-lifecycle test-metaclass-construction test-untyped-pointer-dereference test-ansistring-pointer-cast test-old-file-api test-getdir test-rmdir test-environment-variable test-change-file-ext test-execute-process test-try-statements test-exception-handlers test-integer-not test-shift-operators test-pointer-equality test-sysutils-exception test-findfirst-findnext test-old-object-lifecycle test-incomplete-type-resolution test-final-methods test-abstract-methods test-abstract-classes test-class-static-methods test-interface-guid test-interfaces-directive test-type-identity-and-compatibility test-operator-argument-matching test-operator-ranking-policies test-overload-ranking test-operator-catalog test-managed-types-and-iteration test-overflow-checking test-q-intrinsics test-q-directive-scoping test-inc-dec-operators test-custom-checked-operators test-custom-range-conversions test-custom-explicit-conversions test-overflow-constants test-index-range-checking test-subrange-carriers test-implicit-ordinal-narrowing test-based-integer-literals test-implicit-conversion-single-edge test-implicit-real-narrowing

.PHONY: all clean distclean test test-packed-record test-ifopt test-directive-push-pop test-h-directive-strings test-directive-diagnostics test-binding-lookup test-global-overload-scope test-case-statement test-math-intrinsics test-loop-control test-empty-statement test-block-comments test-generic-intrinsics test-length-native-types test-pos-builtin test-copy-builtin test-chr-builtin test-str-builtin test-val-builtin test-octstr-builtin test-strlen-builtin test-getmem-builtin test-move-builtin test-initialize-finalize test-filldword-builtin test-prefetch-builtin test-comparechar-builtin test-sizeof-layout test-set-literals test-include-exclude-builtin test-writable-cast test-write-builtin test-builtin-overload-isolation test-i-directive-scoping test-io-checking test-runerror-halt test-unit-lifecycle test-unit-uses-scope test-symbol-resolution test-delete-builtin test-insert-builtin test-properties test-with-designator test-function-pointers test-single-type test-shortstring-type test-typed-const-aggregates test-explicit-enum-values test-type-block-publication test-inherited-calls test-file-types test-classtype-emission test-metaclass-lifecycle test-metaclass-construction test-untyped-pointer-dereference test-ansistring-pointer-cast test-old-file-api test-getdir test-rmdir test-environment-variable test-change-file-ext test-execute-process test-try-statements test-exception-handlers test-integer-not test-shift-operators test-pointer-equality test-sysutils-exception test-findfirst-findnext test-old-object-lifecycle test-incomplete-type-resolution test-final-methods test-abstract-methods test-abstract-classes test-class-static-methods test-interface-guid test-interfaces-directive test-type-identity-and-compatibility test-operator-argument-matching test-operator-ranking-policies test-overload-ranking test-operator-catalog test-managed-types-and-iteration test-overflow-checking test-q-intrinsics test-q-directive-scoping test-inc-dec-operators test-custom-checked-operators test-custom-range-conversions test-custom-explicit-conversions test-overflow-constants test-index-range-checking test-subrange-carriers test-implicit-ordinal-narrowing test-based-integer-literals test-implicit-conversion-single-edge test-implicit-real-narrowing
