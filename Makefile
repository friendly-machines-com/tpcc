...
test-widechar-type: mp
	sh tests/test_widechar_type.sh
...
test-custom-narrowing-conversions: mp
	sh tests/test_custom_narrowing_conversions.sh
...
.PHONY: test-new-designator
test-new-designator: mp
	sh tests/test_new_designator.sh

.PHONY: test-multi-error-reporting
test-multi-error-reporting: mp
	sh tests/test_multi_error_reporting.sh

.PHONY: test-hygiene
test-hygiene:
	sh tests/test_hygiene.sh

.PHONY: test-recent-rtl
test-recent-rtl: mp
