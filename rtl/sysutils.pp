...
function RenameFile(const OldName, NewName: AnsiString): Boolean; external name '::u_sysutils::p_renamefile';
function FileGetDate(Handle: LongInt): LongInt; external name '::u_sysutils::p_filegetdate';
function FileSetDate(Handle: LongInt; Age: LongInt): LongInt; overload; external name '::u_sysutils::p_filesetdate';
function FileSetDate(const FileName: AnsiString; Age: LongInt): LongInt; overload; external name '::u_sysutils::p_filesetdate_name';
function GetFileHandle(var f: File): LongInt; external name '::u_sysutils::p_getfilehandle_file';
function GetFileHandle(var f: Text): LongInt; external name '::u_sysutils::p_getfilehandle_text';
