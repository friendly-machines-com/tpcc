...
class Frame {
	...
	CallableRegistration collect_callable(std::string name, Callable* c);
	...
	CallableRegistration register_callable(std::string name, Callable* c);
	...
	std::vector<std::pair<std::string, Type*>> type_declarations() const;
	std::vector<std::pair<std::string, FrameValueEntry>> value_declarations() const;
