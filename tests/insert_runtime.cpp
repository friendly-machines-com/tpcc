...
static ::u_system::t_shortstring<255> repeated(char value, std::size_t length) {
...
int main() {
	...
	if (characters.length != 3 || characters.data[0] != 'a' || characters.data[1] != 'b' || characters.data[2] != 'c') {
		return 6;
	}
