...
int main() {
	...
	if (!equals(::u_system::p_octstr(static_cast<::u_system::t_longint>(83), 2), "23"))
		return EXIT_FAILURE;
	if (!equals(::u_system::p_octstr(static_cast<::u_system::t_longint>(-1), 12),
	            "777777777777"))
		return EXIT_FAILURE;
	if (!equals(::u_system::p_octstr(static_cast<::u_system::t_int64>(8), 3), "010"))
		return EXIT_FAILURE;
	if (!equals(::u_system::p_octstr(static_cast<::u_system::t_qword>(-1), 22),
	...
	auto maximum =
	    ::u_system::p_octstr(static_cast<::u_system::t_longint>(0), 255);
